...
public class XsdGenerationTest {
     ...
     * @throws Exception
     */
    public XsdGenerationTest() throws Exception {
        SchemaFactory factory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
        Document schemaDom = EntityXsdGenerator.generateSchema(TestEntityRegistry.INSTANCE, new BaseXmlFieldConverterFactory(TestEntityRegistry.INSTANCE), Record.class);
