...
public final class ProviderKeys {
    ...
    @FieldId(5)
    public static final TKey<ProviderKeys, ProviderType> PROVIDER_TYPE = TKey.register(
            ProviderKeys.class,
            "ProviderType",
            ProviderType.class);
    ...
    @FieldId(202)
    public static final TKey<ProviderKeys, DatasetRelation> DATASET = TKey.register(
            ProviderKeys.class,
            "Dataset",
            DatasetRelation.class);

    @FieldId(203)
    public static final TKey<ProviderKeys, ContactRelation> CONTACT = TKey.register(
            ProviderKeys.class,
            "Contact",
