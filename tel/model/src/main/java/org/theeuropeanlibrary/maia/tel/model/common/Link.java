...
import org.theeuropeanlibrary.maia.tel.model.common.qualifier.LinkStatus;
...
public class Link {
    ...
    public boolean equals(Object obj) {
        ...
        Link other = (Link) obj;
        if (cachedPath == null) {
            if (other.cachedPath != null) {
                return false;
            }
        } else if (!cachedPath.equals(other.cachedPath)) {
            return false;
        }
        if (lastChecked == null) {
        ...
        if (anchorKey == null) {
            if (other.anchorKey != null) {
                return false;
            }
        } else if (!anchorKey.equals(other.anchorKey)) {
            return false;
        }
        return true;
    }
