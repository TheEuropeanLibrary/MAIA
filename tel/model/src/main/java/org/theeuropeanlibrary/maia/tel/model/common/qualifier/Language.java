...
/**
 * Language enum with english language name and ISO639-2 3 letter codes, ISO639
 * 2 letter codes and available java locale.
 *
...
public enum Language {
    ...
    /**
     *
     * @param locale of the language returned in specified language
     * @return name
     */
    ...
    /**
     * @param name natural name of language
    ...
    /**
     * @param iso2 iso2 code of language
    ...
    /**
     * @param iso3 iso3 code of language
    ...
    /**
     * @param locale iso3 code of language
     * @return language as enum looked up by iso3
     */
    ...
    /**
     * @param languageNameOrCode iso3, iso2, marc or name
     * @return language as enum looked up implicitly recognized type of given
